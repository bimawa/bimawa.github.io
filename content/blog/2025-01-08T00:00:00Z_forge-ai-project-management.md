+++
title = "Forge: When Developers Become Managers (with AI Cats as Assistants)"
date = 2026-01-08T12:00:00Z
description = "A story about how AI is changing the role of developers and why Forge might become your perfect tool for managing tasks with AI agents"
[taxonomies]
...
The old chain was: manager → developer → code.
Now it's: developer → AI agent → code.
...
**Check it out:** [github.com/automagik-dev/forge](https://github.com/automagik-dev/forge)
...
*P.P.S. Oh you piece of sh*t! Did you think I wouldn't read what you wrote here?*
